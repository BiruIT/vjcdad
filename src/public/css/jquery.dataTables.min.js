            ...
            if (!h._aFilterData) {
                ...
                for (d = b.length; n < d; n++) {
                    ...
                    m.indexOf &&
                        -1 !== m.indexOf('&') &&
                        ((Pa.innerHTML = m),
                        (m = rc ? Pa.textContent : Pa.innerText));
    ...
    function Fa(a) {
        ...
        if (a.scrollBarVis !== ha && a.scrollBarVis !== q)
            ...
            I &&
                ba(function (F, Y) {
                    F.innerHTML =
                        '<div class="dataTables_sizing">' + Aa[Y] + '</div>';
                    F.childNodes[0].style.height = '0';
                    F.childNodes[0].style.overflow = 'hidden';
                    F.style.width = aa[Y];
                }, ka);
            r.outerWidth() < f
                ? ((la =
                  ...
                  M &&
                      ...
                      (D.width = K(la - b)),
                  ('' !== c && '' === d) ||
                      ca(a, 1, 'Possible column misalignment', 6))
                : (la = '100%');
            p.width = K(la);
            g.width = K(la);
    ...
    var u = function (a) {
            ...
            this.each(function () {
                ...
                if ('table' != this.nodeName.toLowerCase())
                    ...
                    if (I.length) {
                        var W = function (B, E) {
                            return null !== B.getAttribute('data-' + E)
                                ? E
                                : null;
                        };
                        k(I[0])
                    ...
                    f = function () {
                        ...
                        0 === E.length || 0 === E.children().length
                            ...
                            : 0 < E.length &&
                              ((r.nTFoot = E[0]), wa(r.aoFooter, r.nTFoot));
                        if (g.aaData)
                    ...
                    if (Array.isArray(g) || g instanceof k)
                        ...
                        g.nodeName && 'tr' === g.nodeName.toLowerCase()
                            ...
                            : ((l = k('<tr><td></td></tr>').addClass(h)),
                              (k('td', l).addClass(h).html(g)[0].colSpan =
                                  na(a)),
                              e.push(l[0]));
                };
            f(c, d);
